    ...
    public static void setLastClicked(TerrainTileFX last) {
        ...
        if (state == GameState.ATTACKING) {
            if (!attack(last)) {
                ...
                alert.setTitle("Attack Status");
                alert.setHeaderText("Attack did not work");
                alert.setContentText("Your attack did not process");
                alert.showAndWait();
            }
            ...
            if (move(last)) {
                ...
                Alert alert = new Alert(AlertType.ERROR);
                alert.setTitle("Move Status");
                alert.setHeaderText("Move did not work");
                alert.setContentText("Your Move did not process");
                alert.showAndWait();
            }
